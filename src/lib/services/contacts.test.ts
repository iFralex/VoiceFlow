...
// markOptOut and bulkMarkOptOut moved to src/lib/services/optout.ts; their
// tests live in src/lib/services/optout.test.ts. The contacts module re-
// exports them for backwards compatibility.
