...
/**
 * Aggregates stats for all currently-running campaigns.
 * Also includes paused campaigns since they may still have in-flight calls.
 */
export async function aggregateCampaignStats(): Promise<AggregationResult> {
