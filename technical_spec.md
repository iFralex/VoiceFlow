...
**Project codename:** *(TBD — placeholder: `VoiceFlow`)*
...
The default disclosure text (in Italian) is approximately: *"Buongiorno, sono [nome] un assistente vocale automatico per conto di [concessionario]. La chiamata sarà gestita da un sistema di intelligenza artificiale. Ha qualche minuto?"*. This is reviewed annually by external counsel.
